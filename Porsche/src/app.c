...
void render_app(App* app)
{
    ...
    if (app->house_state == HOUSE_MOVING_UP && app->scene.house.v_secondhouse_trans.y < 100.0f)
        app->scene.house.v_secondhouse_trans.y += 0.1f;
    else if (app->house_state == HOUSE_MOVING_UP)
        app->house_state = HOUSE_STATIONARY;
    

    if (app->house_state == HOUSE_MOVING_DOWN && app->scene.house.v_secondhouse_trans.y > -17.0f)
        app->scene.house.v_secondhouse_trans.y -= 0.1f;
